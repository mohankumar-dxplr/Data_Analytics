...
![Year-over-Year Monthly Revenue](./figures/a3_time_series.png)
...
![Revenue by Category](./figures/a1_revenue_overview.png)
...
![Profit Margin by Category](./figures/a1_margin_by_category.png)
...
![Product Cost vs Price](./figures/04_products_cost_vs_price.png)
*Figure 9: Cost vs. price scatter plot shows the relationship between product cost and retail price across categories.*

![Category Price Distribution](./figures/03_products_category_price.png)
...
![Sales by Age Group](./figures/10_sales_by_age_group.png)
...
![Customer Segments](./figures/a2_customer_segments.png)
...
![Top 10 Customers](./figures/a2_top_customers.png)
...
![COVID Revenue Trend](./figures/investigation_covid_trend.png)
...
![Category Recovery](./figures/investigation_category_recovery.png)
...
![Customer Churn Waterfall](./figures/investigation_customer_churn.png)
...
![Country Impact Heatmap](./figures/investigation_country_heatmap.png)
...
![Online vs Physical](./figures/investigation_store_type.png)
...
![Delivery Overview](./figures/a4_delivery_overview.png)
...
![Product Affinity](./figures/a5_product_affinity.png)
...
![Executive Dashboard](./figures/a6_executive_dashboard.png)
